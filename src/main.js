...
function buildLibraryHeroHtml() {
  return `<section class="home-hero">
    ...
    <div class="home-hero__visual" aria-hidden="true">
      ...
      <div class="hero-ring hero-ring--right"></div>
      <div class="hero-float hero-float--video"></div>
      <div class="hero-float hero-float--doc"></div>
      <div class="hero-book">
        <div class="hero-book__page hero-book__page--left"></div>
        <div class="hero-book__page hero-book__page--right"></div>
        <div class="hero-book__base"></div>
      </div>
    </div>
  </section>`;
}
